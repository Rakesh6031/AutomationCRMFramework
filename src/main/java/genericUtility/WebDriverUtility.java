...
public class WebDriverUtility {
	...
	/**
	 * This method is used to Wait until the element is loaded in given time duartion provide driver
	 * @param driver
	 */
	...
	/**
	 * This method i used wait until the element is visible provided driver and element
	 * @param driver
	 * @param element
	 */
	...
	/**
	 * This method is used to handle dropdown using visible text provided element and text
	 * @param text
	 * @param element
	 */
	...
	/**
	 * This method is used to capture text in alert popup and accept it provided driver 
	 * @param driver
	 * @return
	 */
	...
	/**
	 * This method is used to take screenshot of an entire webpage provided driver and screenshotname
	 * @param driver
	...
	/**
	 * This method is used to transfer driver control to window provided driver and partialTitle
	 * @param driver
	 * @param partialTitle
	 */
